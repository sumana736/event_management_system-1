        ...
        <section class="content">
          <div class="row">
            ...
            <div class="col-md-12">
             ...
             <p><b>Welcome Vendor</b></p>
				
	<form role="form" name="frm" method="post">
				<div class="box-footer">
                    <input type="submit" value="Item" name="item" onclick="return show();">
                  </div>
				  <div class="box-footer">
                    <input type="submit" value="Add New Item" name="newitem" onclick="return show();">
                  </div>
				  <div class="box-footer">
                    <input type="submit" value="Transaction" name="t" onclick="return show();">
                  </div>
				  <div class="box-footer">
